...
class Line(object):
    ...
    def line_plus(self, other_line):
        ...
        #        They include the Example in the above doc-string.
        # --------------------------------------------------------------
        sx = other_line.start.x + self.start.x
        sy = other_line.start.y + self.start.y
        ex = other_line.end.x + self.end.x
        ey = other_line.end.y + self.end.y
        p1 = Point(sx, sy)
        p2 = Point(ex, ey)
        new_line = Line(p1,p2)
        return new_line
    ...
    def line_minus(self, other_line):
        ...
        #        They include the Example in the above doc-string.
        # --------------------------------------------------------------
        sx = self.start.x - other_line.start.x
        sy = self.start.y - other_line.start.y
        ex = self.end.x - other_line.end.x
        ey = self.end.y - other_line.end.y
        p1 = Point(sx, sy)
        p2 = Point(ex, ey)
        new_line = Line(p1,p2)
        return new_line
